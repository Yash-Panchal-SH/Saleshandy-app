...
Plain lists of what the new version needs. No status tags, no rebuild/reuse markers, no prose. Sourced from `REBUILD_INVENTORY.md`.

## Index

1. [Screens](01-screens.md)
2. [Components](02-components.md)
3. [Design System](03-design-system.md)
4. [UX Patterns](04-ux-patterns.md)
5. [AI Tooling](05-ai-tooling.md)
6. [Docs](06-docs.md)
7. [Global Setup](07-global-setup.md)
